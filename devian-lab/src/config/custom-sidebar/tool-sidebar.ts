...
const SubSidebarList: SidebarItemConfig[] = [
  {
    ...
    items: [
      ...
      `${SubSidebarRootPath.Git}/how-to-change-git-remote-repo-url`,
      `${SubSidebarRootPath.Git}/how-to-install-the-latest-git`,
    ],
  },
  {
    type: 'category',
  ...
  },
  {
    ...
    items: [
      `${SubSidebarRootPath.Linux}/how-to-install-font`,
    ],
  },
  {
    type: 'category',
